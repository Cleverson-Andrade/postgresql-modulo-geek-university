# PostgreSQL — Practical Module (Geek University)

## 🇧🇷 Português

Este repositório contém os **códigos SQL desenvolvidos durante o Módulo de PostgreSQL** do curso  
**“Bancos de Dados SQL e NoSQL — do básico ao avançado”**, ministrado pela **Geek University** e disponibilizado na plataforma **Udemy**.

O objetivo deste módulo é apresentar os **fundamentos do PostgreSQL**, destacando suas características, sintaxe e comportamentos específicos, além de comparações pontuais com outros SGBDs, como o MySQL.

Todo o conteúdo foi desenvolvido com foco **didático e prático**, servindo como material de estudo, revisão e demonstração de conhecimento em SQL e PostgreSQL.
...
- Consolidar os fundamentos do PostgreSQL  
- Praticar comandos SQL essenciais  
- Demonstrar organização e clareza na escrita de scripts SQL  
- Servir como material de portfólio e referência profissional  
...
This repository contains the **SQL scripts developed during the PostgreSQL module** of the course  
**“SQL and NoSQL Databases — from basic to advanced”**, provided by **Geek University** and available on **Udemy**.

The purpose of this module is to present the **fundamentals of PostgreSQL**, highlighting its syntax, behavior, and specific features, as well as brief comparisons with other DBMSs such as MySQL.

All content was created with a **practical and educational focus**, serving as study material, review content, and a demonstration of SQL and PostgreSQL knowledge.
...
- Practice essential SQL commands  
- Demonstrate clean and organized SQL scripting  
